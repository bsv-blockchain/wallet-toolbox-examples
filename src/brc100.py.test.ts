...
describe('BRC-100 Wallet Operations (Python Storage Server)', () => {
  ...
  beforeAll(async () => {
    const endpointUrl = process.env.PY_WALLET_TOOLBOX_URL || DEFAULT_PY_WALLET_TOOLBOX_URL
    ...
    try {
      ...
      console.log('Test wallet identity key:', setup.identityKey)
      console.log('Test wallet root key:', env.devKeys[env.identityKey])
